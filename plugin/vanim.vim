...
" command bindings
command! -nargs=? VanimRenderL :silent exec python3 vanim.render("l", <args>)
command! -nargs=? VanimRenderM :silent exec python3 vanim.render("m", <args>)
command! -nargs=? VanimRenderH :silent exec python3 vanim.render("h", <args>)
command! -nargs=? VanimRenderP :silent exec python3 vanim.render("p", <args>)
command! -nargs=? VanimRenderK :silent exec python3 vanim.render("k", <args>)
command! -nargs=? VanimRenderAll :silent exec python3 vanim.render_all(<args>)
